...
class Postagem
{
    public static function selecionaTodos()
    {
        ...
        if (!$resultado) {
            throw new Exception("Não foi encontrado nehum registro no banco");
        }
    ...
    public static function selecionaPorId($idPost)
    {
        ...
        if (!$resultado) {
            throw new Exception("Nao foi encontrado nehum registro");
        } else {
    ...
    public static function update($params)
    {
        ...
        if ($resultado == 0) {
            throw new Exception("Falha ao alterar pub");
    ...
    public static function delete($id)
    {
        ...
        if ($resultado == 0) {
            throw new Exception("Falha ao Deletar public");
